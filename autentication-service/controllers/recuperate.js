...
const accountSid = 'ACfbe7520ee0db240f3a87d2b1618b607e';
const authToken = '134ecf6bd0c1eb21f60378c679e368df';
...
exports.resetPassword = async (req, res) => {
    ...
    try {
        ...
        await axios.post(`http://localhost:5000/api/v1/users/${user.email}/updatePassword/${newPassword}`);
        ...
        await client.messages.create({
            ...
            from: '+14092152405', // Reemplaza con tu número de teléfono de Twilio
            to: fullPhoneNumber
        });
